...
import { getWorkshopList, deleteWorkshop } from '@/api/workshop'
...
function handleCreate() {
  router.push({ name: 'workshop-create' })
}

function handleEdit(id) {
  router.push({ name: 'workshop-edit', params: { id } })
}
