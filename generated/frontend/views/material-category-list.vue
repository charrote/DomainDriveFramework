...
import { getMaterialCategoryList, deleteMaterialCategory } from '@/api/material-category'
...
async function fetchData() {
  try {
    ...
    console.error('Failed to fetch MaterialCategory:', err)
  }
}
...
function handleCreate() {
  router.push({ name: 'material-category-create' })
}

function handleEdit(id) {
  router.push({ name: 'material-category-edit', params: { id } })
}
