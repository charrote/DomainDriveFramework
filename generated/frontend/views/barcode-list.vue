      ...
      <table class="ddf-table">
        ...
        <tbody>
          <tr v-for="row in dataList" :key="row.id">
            ...
            <td>
              {{ row.production_date ? new Date(row.production_date).toLocaleString() : '-' }}
            </td>
...
import { getBarcodeList, deleteBarcode } from '@/api/barcode'
...
function handleCreate() {
  router.push({ name: 'barcode-create' })
}

function handleEdit(id) {
  router.push({ name: 'barcode-edit', params: { id } })
}
