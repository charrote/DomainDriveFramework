...
import { getBOMItemList, deleteBOMItem } from '@/api/bom-item'
...
async function fetchData() {
  try {
    const res = await getBOMItemList({
      page: page.value,
    ...
    console.error('Failed to fetch BOMItem:', err)
  }
}
...
function handleCreate() {
  router.push({ name: 'bom-item-create' })
}

function handleEdit(id) {
  router.push({ name: 'bom-item-edit', params: { id } })
}
