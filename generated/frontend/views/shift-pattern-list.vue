...
import { getShiftPatternList, deleteShiftPattern } from '@/api/shift-pattern'
...
async function fetchData() {
  try {
    const res = await getShiftPatternList({
      page: page.value,
    ...
    console.error('Failed to fetch ShiftPattern:', err)
  }
}
...
function handleCreate() {
  router.push({ name: 'shift-pattern-create' })
}

function handleEdit(id) {
  router.push({ name: 'shift-pattern-edit', params: { id } })
}
