<template>
  <div class="page-container">
    ...
    <div class="page-header">
      <h1 class="page-title">{{ isEdit ? '编辑' : '新建' }}设备</h1>
    ...
    <div class="form-wrapper">
      <div class="form-grid">
        ...
        <div class="form-group" :class="'string'">
          ...
          <input type="text" v-model="form.device_code" class="form-input" />
        </div>
        ...
        <div class="form-group" :class="'string'">
          ...
          <input type="text" v-model="form.device_name" class="form-input" />
        </div>
        ...
        <div class="form-group" :class="'relation'">
          ...
          <input type="number" v-model.number="form.category_id" class="form-input" placeholder="DeviceCategory" />
        </div>
        ...
        <div class="form-group" :class="'date'">
          ...
          <input type="date" v-model="form.purchase_date" class="form-input" />
        </div>
        ...
        <div class="form-group" :class="'date'">
          ...
          <input type="date" v-model="form.last_maintenance_date" class="form-input" />
        </div>
...
async function handleSubmit() {
  ...
  try {
    if (isEdit.value) {
      await updateDevice(route.params.id, form.value)
    } else {
