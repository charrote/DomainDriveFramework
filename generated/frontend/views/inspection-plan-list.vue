...
import { getInspectionPlanList, deleteInspectionPlan } from '@/api/inspection-plan'
...
async function fetchData() {
  try {
    ...
    console.error('Failed to fetch InspectionPlan:', err)
  }
}
...
function handleCreate() {
  router.push({ name: 'inspection-plan-create' })
}

function handleEdit(id) {
  router.push({ name: 'inspection-plan-edit', params: { id } })
}
