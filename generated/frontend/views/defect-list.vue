      ...
      <table class="ddf-table">
        ...
        <tbody>
          <tr v-for="row in dataList" :key="row.id">
            ...
            <td>
              <DdfTag color="primary" size="sm">{{ row.severity }}</DdfTag>
            </td>
...
import { getDefectList, deleteDefect } from '@/api/defect'
...
function handleCreate() {
  router.push({ name: 'defect-create' })
}

function handleEdit(id) {
  router.push({ name: 'defect-edit', params: { id } })
}
