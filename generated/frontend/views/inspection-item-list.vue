...
import { getInspectionItemList, deleteInspectionItem } from '@/api/inspection-item'
...
async function fetchData() {
  try {
    ...
    console.error('Failed to fetch InspectionItem:', err)
  }
}
...
function handleCreate() {
  router.push({ name: 'inspection-item-create' })
}

function handleEdit(id) {
  router.push({ name: 'inspection-item-edit', params: { id } })
}
