...
import { getProcessRouteList, deleteProcessRoute } from '@/api/process-route'
...
async function fetchData() {
  try {
    ...
    console.error('Failed to fetch ProcessRoute:', err)
  }
}
...
function handleCreate() {
  router.push({ name: 'process-route-create' })
}

function handleEdit(id) {
  router.push({ name: 'process-route-edit', params: { id } })
}
