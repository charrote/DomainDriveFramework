...
import { getProductionLineList, deleteProductionLine } from '@/api/production-line'
...
async function fetchData() {
  try {
    ...
    console.error('Failed to fetch ProductionLine:', err)
  }
}
...
function handleCreate() {
  router.push({ name: 'production-line-create' })
}

function handleEdit(id) {
  router.push({ name: 'production-line-edit', params: { id } })
}
