...
import { getProductBOMList, deleteProductBOM } from '@/api/product-bom'
...
async function fetchData() {
  try {
    ...
    console.error('Failed to fetch ProductBOM:', err)
  }
}
...
function handleCreate() {
  router.push({ name: 'product-bom-create' })
}

function handleEdit(id) {
  router.push({ name: 'product-bom-edit', params: { id } })
}
