...
import { getProductionRecordList, deleteProductionRecord } from '@/api/production-record'
...
async function fetchData() {
  try {
    const res = await getProductionRecordList({
      page: page.value,
    ...
    console.error('Failed to fetch ProductionRecord:', err)
  }
}
...
function handleCreate() {
  router.push({ name: 'production-record-create' })
}

function handleEdit(id) {
  router.push({ name: 'production-record-edit', params: { id } })
}
