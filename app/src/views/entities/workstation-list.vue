...
import { getWorkstationList, deleteWorkstation } from '@/api/workstation'
...
function handleCreate() {
  router.push({ name: 'workstation-create' })
}

function handleEdit(id) {
  router.push({ name: 'workstation-edit', params: { id } })
}
