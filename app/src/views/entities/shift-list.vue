      ...
      <table class="ddf-table">
        ...
        <tbody>
          <tr v-for="row in dataList" :key="row.id">
            ...
            <td>
              {{ row.shift_date ? new Date(row.shift_date).toLocaleString() : '-' }}
            </td>
...
import { getShiftList, deleteShift } from '@/api/shift'
...
function handleEdit(id) {
  router.push({ name: 'shift-edit', params: { id } })
}
