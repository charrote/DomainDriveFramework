...
import { getDeviceCategoryList, deleteDeviceCategory } from '@/api/device-category'
...
async function fetchData() {
  try {
    ...
    console.error('Failed to fetch DeviceCategory:', err)
  }
}
...
function handleCreate() {
  router.push({ name: 'device-category-create' })
}

function handleEdit(id) {
  router.push({ name: 'device-category-edit', params: { id } })
}
