...
import { getDefectCategoryList, deleteDefectCategory } from '@/api/defect-category'
...
async function fetchData() {
  try {
    const res = await getDefectCategoryList({
      page: page.value,
    ...
    console.error('Failed to fetch DefectCategory:', err)
  }
}
...
function handleCreate() {
  router.push({ name: 'defect-category-create' })
}

function handleEdit(id) {
  router.push({ name: 'defect-category-edit', params: { id } })
}
