...
const paths = {
  ...
  cpu: 'M9 2v4M15 2v4M9 18v4M15 18v4M2 9h4M18 9h4M2 15h4M18 15h4 M5 6h14a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1z',
  ...
  alertTriangle: 'M10.29 3.86l-7.84 13.48A1.5 1.5 0 0 0 3.66 19h16.68a1.5 1.5 0 0 0 1.21-2.66l-7.84-13.48a1.5 1.5 0 0 0-2.42 0z M12 9v4M12 17h.01',
}

const path = computed(() => paths[toCamel(props.name)] || '')
</script>
